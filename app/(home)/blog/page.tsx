  ...
  return (
    <main className="container max-sm:px-0 md:py-12">
      <div
        ...
        style={{
          backgroundImage: [
            'radial-gradient(circle at 70% 10%, rgba(76, 0, 255, 0.5), transparent)',
            'radial-gradient(circle at 0% 80%, rgba(189, 189, 189, 0.5), transparent)',
            'radial-gradient(circle at 50% 50%, rgba(153, 0, 255, 0.3), transparent)',
